<%@ page import="edu.uic.cri.portal.ProjectManagementServlet, edu.uic.cri.portal.model.entities.arvados.Group" %><!DOCTYPE html>
<html>
<head>
	...
	+ function($) {
	    ...
	    uploadForm.addEventListener('submit', function(e) {
	        ...
	        for ( var i = 0; i < files.length; i++ ) {
				...
				aTag.innerHTML = '<div class="progress-bar" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"></div><span id="status_'+file.name+'" class="badge alert-success pull-right"></span>' + file.name;
...
<div class="container">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <!-- Progress Bar -->
          <div class="progress">
            <div id="progress-bar" class="progress-bar" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width: 70%;">
